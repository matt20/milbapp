...
st.set_page_config(page_title='AAA Offensive Leaderboards', layout="wide")
st.header('AAA Offensive Leaderboards')
...
age_input = st.sidebar.slider('Max Age:', 17, 40, 30)
...
### --- LOAD DATAFRAMES
dfrecent = pd.read_csv(r'C:/Users/mwpul/milbapp/aaarecent.csv', 
                 index_col ='idlevel')

dftotal = pd.read_csv(r'C:/Users/mwpul/milbapp/dfaaa.csv', 
                 index_col ='idlevel')
