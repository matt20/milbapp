...
st.set_page_config(page_title='AA Offensive Leaderboards', layout="wide")
st.header('AA Offensive Leaderboards')
...
age_input = st.sidebar.slider('Max Age:', 17, 40, 24)
...
### --- LOAD DATAFRAMES
dfrecent = pd.read_csv(r'C:/Users/mwpul/milbapp/aarecent.csv', 
                 index_col ='idlevel')

dftotal = pd.read_csv(r'C:/Users/mwpul/milbapp/dfaa.csv', 
                 index_col ='idlevel')
