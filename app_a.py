...
st.set_page_config(page_title='Single-A Offensive Leaderboards', layout="wide")
st.header('Single-A Offensive Leaderboards')
...
### --- LOAD DATAFRAMES
dfrecent = pd.read_csv(r'C:/Users/mwpul/milbapp/arecent.csv', 
                 index_col ='idlevel')

dftotal = pd.read_csv(r'C:/Users/mwpul/milbapp/dfa.csv', 
                 index_col ='idlevel')
