...
input_buffer_other = st.sidebar.slider('Other Buffer:', .0, .100, .025)
...
cols_hist = ['name', 'team', 'level', 'level_code', 'age', 'season', 'pa', 'wrcplus','iso','kpct','swstrpct','bbpct', 'xSpect',
             'babip', 'avg', 'obp', 'slg', 'hr', 'sb','hrperfb', 'fbpct', 'ldpct', 'gbpct', 'pullpct', 'centpct', 'oppopct']

cols_curr = ['Name/Org', 'Age', 'Level', 'hmm', 'PA', 'wRC+', 'K%', 'SwStr%', 'ISO', 'xSpect', 
         #'xPOPS', 
...
dfhist2.sort_values(by='wrcplus', ascending=False)
#######################################################################
...
if sel_row != "":
    ...
    # sel_buff_kpct = (sel_kpct + input_buffer_other).round(3)
    # sel_buff_bbpct = (sel_bbpct + input_buffer_other).round(3)
...
#                   (dfhist2['kpct'] <= sel_buff_kpct) &
#                   (dfhist2['bbpct'] >= sel_buff_bbpct) &
#                   #(dfhist2['wrcplus'] >= sel_wrcplus)
#                   ()
#                   ] 
